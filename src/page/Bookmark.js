...
const cardData = [
  {
    ...
    date: "2023-01-01",
    keyword: ["키워드1", "키워드2", "키워드3", "키워드5", "키워드6", "키워드7"],
  },
  {
    id: 2,
    content:
...
const Bookmark = () => {
  // let carddatakeyword = cardData;
  // let comment = [...new Set(cardData.keyword.map(JSON.stringify))].map(
  //   JSON.parse
  // );
  // console.log(comment);

  let comment =
    "#키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드, #키워드";
  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto mt-20 px-20">
        ...
        <div className="box-border bg-white p-6 border-2 rounded-2xl my-2 ">
          <div>{commenter}</div>
